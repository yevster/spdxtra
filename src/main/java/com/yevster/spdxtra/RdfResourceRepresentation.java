...
public abstract class RdfResourceRepresentation {
    ...
    /**
     * Returns the value of a property that can contain NOASSERTION, NONE, a literal value, or a URI.
     * If the property is omitted from the document, NOASSERTION is returned.
     *
     * @param property
     * @return
     */
    protected NoneNoAssertionOrValue getPropertyAsNoneNoAssertionOrValue(Property property) {
        Statement stmt = rdfResource.getProperty(property);
        if (stmt == null) return NoneNoAssertionOrValue.NO_ASSERTION;
