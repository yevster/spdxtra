...
public final class Write {
    ...
    public static final class Document {
        ...
        public static ModelUpdate addPackage(String documentBaseUrl, String documentSpdxId, String packageSpdxId, final String packageSpdxName) {
     ...
     * @param newDatasetPath The path to which to persist the RDF triple store with SPDX
     *                       data.
     * @return
     */
